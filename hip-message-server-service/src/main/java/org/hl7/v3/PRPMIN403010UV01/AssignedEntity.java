...
public class AssignedEntity {
    ...
    public static class AssignedPrincipalOrganization {
        ...
        public static class AsAffiliate {
            ...
            protected List<AssignedEntity.AssignedPrincipalOrganization.AsAffiliate.AffiliatedPrincipalOrganization> affiliatedPrincipalOrganization;
            @XmlAttribute(name = "classCode")
            protected String classCode;
             ...
             * <p>
             * Objects of the following type(s) are allowed in the list
             * {@link AssignedEntity.AssignedPrincipalOrganization.AsAffiliate.AffiliatedPrincipalOrganization }
             * 
             * 
             */
            public List<AssignedEntity.AssignedPrincipalOrganization.AsAffiliate.AffiliatedPrincipalOrganization> getAffiliatedPrincipalOrganization() {
                if (affiliatedPrincipalOrganization == null) {
                    affiliatedPrincipalOrganization = new ArrayList<AssignedEntity.AssignedPrincipalOrganization.AsAffiliate.AffiliatedPrincipalOrganization>();
                }
