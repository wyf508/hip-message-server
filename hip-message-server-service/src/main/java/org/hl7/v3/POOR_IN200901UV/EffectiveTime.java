...
public class EffectiveTime {
    ...
    protected List<EffectiveTime.Low> low;
    protected List<EffectiveTime.High> high;
     ...
     * {@link EffectiveTime.Low }
     * 
     * 
     */
    public List<EffectiveTime.Low> getLow() {
        if (low == null) {
            low = new ArrayList<EffectiveTime.Low>();
        }
        return this.low;
    }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link EffectiveTime.High }
     * 
     * 
     */
    public List<EffectiveTime.High> getHigh() {
        if (high == null) {
            high = new ArrayList<EffectiveTime.High>();
        }
        return this.high;
    }
