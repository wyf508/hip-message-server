...
import com.djhu.hiup.message.server.core.dao.IReserveRisDao;
 ...
 */
@Component(ServiceName.RESERVE_RIS)
public class ReserveRisServiceImpl implements IHIPMessageServerService {

    @Resource
    private IReserveRisDao reserveRisDao;

    @Override
    public int saveMessage(Map<String, Object> keyAndXmlValMap) throws Exception{
        int count = reserveRisDao.selectCountBySelective(keyAndXmlValMap);
        if (count > 0) {
            throw new DataExistedException();
        }
        return reserveRisDao.insertSelective(keyAndXmlValMap);
    }
    ...
    public int updateMessage(Map<String, Object> keyAndXmlValMap) throws Exception{
        ...
        return reserveRisDao.updateBySelective(keyAndXmlValMap);
    }

    @Override
    public List selectMessage(Map<String, Object> keyAndXmlValMap) throws Exception{
        return reserveRisDao.selectBySelective(keyAndXmlValMap);
    }
}
