...
public class StatusRis {
    ...
    private List<RisCheckStatus> risCheckStatusList=new ArrayList<>();
    ...
    public List<RisCheckStatus> getRisCheckStatusList() {
        return risCheckStatusList;
    }

    public void setRisCheckStatusList(List<RisCheckStatus> risCheckStatusList) {
        this.risCheckStatusList = risCheckStatusList;
    }
}