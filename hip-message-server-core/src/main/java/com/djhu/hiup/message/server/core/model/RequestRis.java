 ...
 * 申请单信息_检查申请单信息表
 */
public class RequestRis extends BaseRequest{
    ...
    private List<RisCheckItem> risCheckItemList=new ArrayList<>();
    ...
    public void setGenderDepict(String genderDepict) {
        this.genderDepict = genderDepict;
    }
    ...
    public List<RisCheckItem> getRisCheckItemList() {
        return risCheckItemList;
    }

    public void setRisCheckItemList(List<RisCheckItem> risCheckItemList) {
        this.risCheckItemList = risCheckItemList;
    }
}